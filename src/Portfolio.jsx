		...
		return (
			<div className="portfolio">
				<div className="hero-background-container">
					...
					<div className="hero-background-image-1" />
						...
						<p className="skill-choices-title-mobile">I am a skilled:</p>
							<div className="skill-choices-container">
								...
								<div className={selectedSkill === 1 ? "skill-choice-container selected" : "skill-choice-container"} onMouseEnter={() => this.handleSelectedSkillHover(1)}>
									...
									<p className="skill-choice-title">Developer</p>
								</div>
								<div className={selectedSkill === 2 ? "skill-choice-container selected" : "skill-choice-container"} onMouseEnter={() => this.handleSelectedSkillHover(2)}>
									...
									<p className="skill-choice-title">Designer</p>
								</div>
							</div>
							<div className="technical-competencies-desktop-border" />
							<div className="skill-choice-info-container">
								<div className="skill-choice-description-container">
									<div className="skill-choice-mobile-border" />
									{selectedSkill === 1 &&
										<p className="skill-choice-description-title">Front End Developer</p>
									}
									{selectedSkill === 2 &&
